...
class ReportController extends Controller
{
    ...
    private function fetchProduction($from, $to): array
    {
        ...
        $availableFields = [
            ...
            'average_yield' => 'Average Yield (MT/ha)',
        ...
        return $this->buildRows(
            ...
            fn ($h, $field) => match ($field) {
                ...
                'area_harvested' => $this->measurementValue($h->area_harvested, 'ha', 'N/A'),
                'average_yield' => $this->measurementValue($h->average_yield, 'MT/ha', 'N/A'),
                'production' => $this->measurementValue($h->production, 'MT', 'N/A'),
